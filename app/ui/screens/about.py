...
STATUS = [
    ...
    ("Загрузка покупок", "ok", "пять форматов",
     "Чек PDF и текстом, JSON от ФНС и операторов данных, таблица заказа CSV или XLSX. "
     "Автоматическая выгрузка из ФНС по авторизации — следующий шаг."),
