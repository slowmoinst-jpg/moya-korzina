...
[data-testid="stSidebar"] [data-testid="stRadioOption"]{
  width:100%%;padding:9px 12px;border-radius:9px;transition:background 120ms ease;
}
[data-testid="stSidebar"] [data-testid="stRadioOption"]:hover{background:var(--tint);}
[data-testid="stSidebar"] [data-testid="stRadioOption"][data-selected="true"]{background:var(--warm-soft);}
[data-testid="stSidebar"] [data-testid="stRadioOption"][data-selected="true"] p{
  font-weight:600;color:var(--ink);
}
[data-testid="stSidebar"] [data-testid="stRadioOption"] p{font-size:0.92rem;color:var(--ink2);}
/* кружок радиокнопки — это див прямо перед подписью; в навигации он лишний */
[data-testid="stSidebar"] [data-testid="stRadioOption"] div:has(+ [data-testid="stMarkdownContainer"]){
  display:none;
}
...
.stTabs [data-baseweb="tab"]{padding:8px 0;color:var(--ink2);}
...
def inject() -> None:
    ...
    st.markdown(CSS % {"fonts": FONTS}, unsafe_allow_html=True)


def logo() -> str:
    """Марка в боковой панели — рисованная иконка вместо эмодзи."""
    return """
<div style="display:flex;align-items:center;gap:11px;padding:2px 0 14px;">
